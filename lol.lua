...
function CheckLevelBosses()
    ...
    if First_Sea then
        if Lv == 25 or Lv <= 54 or _G.SelectBoss == "The Gorrila King" then
            ...
            _G.QuestLv = 3
            _G.NameMon = "The Gorilla King [Lv. 25] [Boss]"
        ...
        elseif Lv == 120 or Lv <= 129 or _G.SelectBoss == "Mob Leader" then
            ...
            _G.NameMon = "Mob Leader [Lv. 120] [Boss]"
            _G.CFrameBoss = CFrame.new(-2844, 7, 5356)
        end
    end
end
